...
def debug(deplacement, ser):
    ...
    ax1.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax2.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax3.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax4.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax5.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax6.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax7.legend(loc='best', fontsize='medium', frameon=True)
    ...
    ax8.legend(loc='best', fontsize='medium', frameon=True)
